package battlePanic.character
{
   ...
   public class Combatant extends §5I§
   {
      ...
      public var §%^§:battlePanic.character.§4[§;
      
      private var §0$§:Function = null;
      
      protected var §3L§:battlePanic.character.§-"§ = null;
      ...
      public var §1G§:battlePanic.character.Combatant = null;
      ...
      public function §<C§(param1:battlePanic.character.Combatant) : void
      {
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = true;
         if(!_loc2_)
      ...
      public function §6V§(param1:battlePanic.character.Combatant) : void
      {
      ...
      public function §-0§(param1:battlePanic.character.Combatant) : void
      {
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = true;
      ...
      public function getIdealAttackPosition(param1:battlePanic.character.Combatant, param2:Number = 30) : §'2§
      {
         var _loc4_:Boolean = false;
         var _loc5_:Boolean = true;
         var _loc3_:§'2§ = null;
      ...
      public function attackClosestEnemy(param1:Boolean = true) : battlePanic.character.Combatant
      {
         ...
         if(_loc5_ || Boolean(_loc3_))
         {
            if(!§§pop())
            {
               while(true)
               {
                  this.§3L§ = battlePanic.character.§-"§.instance;
                  loop1:
                  while(true)
                  {
      ...
      protected function syncToDefinition(param1:battlePanic.character.§4[§) : void
      {
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = true;
         if(_loc3_ || Boolean(param1))
