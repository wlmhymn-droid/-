package battlePanic.sound
{
   ...
   public class PanicSound
   {
      ...
      private static var _instance:battlePanic.sound.PanicSound;
      ...
      private var _frequencyLimiter:battlePanic.sound.EventFrequencyLimiter;
      
      private var _musicVolume:Number = 1;
      
      private var _soundTrack:battlePanic.sound.SoundTrack;
      
      private const TAKE_DAMAGE:int = .(battlePanic.sound.PanicSound);
      ...
      public function PanicSound(param1:SingletonBlocker)
      {
         ...
         this._soundManager = .getInstance();
         this._frequencyLimiter = new battlePanic.sound.EventFrequencyLimiter();
         this._soundTrack = new battlePanic.sound.SoundTrack();
         while(true)
         {
            this.SHOOT_ARROW = .(battlePanic.sound.PanicSound);
            while(true)
            {
               this.ARROW_HIT = .(battlePanic.sound.PanicSound);
               do
               {
                  this.HUMAN_DIE = .(battlePanic.sound.PanicSound);
               }
               ...
               this.ORC_DIE = .(battlePanic.sound.PanicSound);
               this.HACK_WALL = .(battlePanic.sound.PanicSound);
               this.ORC_SPEAR = .(battlePanic.sound.PanicSound);
               this.HORSEMAN_DIE = .(battlePanic.sound.PanicSound);
               super();
               if(param1 != null)
               {
                  do
      ...
      public static function getInstance() : battlePanic.sound.PanicSound
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc2_ || _loc2_)
            {
               if(pop() == null)
               {
                  if(_loc2_ || _loc1_)
                  {
                     _instance = new battlePanic.sound.PanicSound(new SingletonBlocker());
                     addr53:
                     push(_instance);
                  }
               }
      ...
      private function init() : void
      {
         ...
         if(_loc1_ || Boolean(this))
         {
            ...
            while(true)
            {
               pop().(OrcRoar1,"orcRoar1");
               push(this._soundManager);
               while(true)
               {
                  pop().(OrcRoar1,"orcRoar2");
                  loop2:
                  while(true)
                  {
                     push(this._soundManager);
                     while(true)
                     {
                        pop().(OrcRoar1,"orcRoar3");
                        push(this._soundManager);
                        while(true)
                        {
                           pop().(OrcRoar1,"orcRoar4");
                           this._soundManager.(OrcRoar1,"orcRoar5");
                           this._soundManager.(OrcRoar1,"orcRoar6");
                           this._soundManager.(OrcRoar1,"orcRoar7");
                           do
                           {
                              this._soundManager.(OrcRoar1,"orcRoar8");
                           }
                           while(_loc2_ && Boolean(this));
                           
                           this._soundManager.(OrcRoar7,"orcRoar9");
                           push(this._soundManager);
                           loop6:
                           while(true)
                           {
                              pop().(OrcRoar10,"orcRoar10");
                              loop7:
                              while(true)
                              {
                                 this._soundManager.(LittleRar1,"littleRar1");
                                 loop8:
                                 while(true)
                                 {
                                    this._soundManager.(LittleRar2,"littleRar2");
                                    push(this._soundManager);
                                    loop9:
                                    while(true)
                                    {
                                       pop().(LittleRar3,"littleRar3");
                                       this._soundManager.(Shing2,"shing2");
                                       this._soundManager.(Whoosh2,"whoosh2");
                                       while(true)
                                       {
                                          push(this._soundManager);
                                          loop11:
                                          while(true)
                                          {
                                             pop().(FleshCut2,"fleshCut1");
                                             while(true)
                                             {
                                                this._soundManager.(Clank1,"clank1");
                                                loop13:
                                                while(true)
                                                {
                                                   this._soundManager.(Clank2,"clank2");
                                                   this._soundManager.(Shing1,"shing1");
                                                   while(true)
                                                   {
                                                      this._soundManager.(Whoosh1,"whoosh1");
                                                      push(this._soundManager);
                                                      while(true)
                                                      {
                                                         pop().(Whoosh2,"whoosh2");
                                                                                 ...
                                                                                 while(_loc1_)
                                                                                 {
                                                                                    ...
                                                                                    while(true)
                                                                                    {
                                                                                       ...
                                                                                       if(!(_loc2_ && _loc2_))
                                                                                       {
                                                                                          ...
                                                                                          while(_loc1_)
                                                                                          {
                                                                                             this._soundManager.(Wood4,"wood4");
                                                                                             while(!(_loc2_ && _loc1_))
                                                                                             {
                                                                                                this._soundManager.(Reinforcements,"reinforcements");
                                                                                                push(this._soundManager);
                                                                                                loop49:
                                                                                                while(true)
                                                                                                {
                                                                                                   pop().(WaveLong,"waveLong");
                                                                                                   while(true)
                                                                                                   {
                                                                                                      push(this._soundManager);
                                                                                                      addr728:
                                                                                                      ...
                                                                                                      while(true)
                                                                                                      {
                                                                                                         ...
                                                                                                         while(true)
                                                                                                         {
                                                                                                            ...
                                                                                                            while(true)
                                                                                                            {
                                                                                                               ...
                                                                                                               while(true)
                                                                                                               {
                                                                                                                  this._soundManager.(LevelUp,"levelUp");
                                                                                                                  push(this._soundManager);
                                                                                                                  continue loop49;
                                                                                                               }
                                                                                                               this._soundManager.(TrainFootman,"trainFootman");
                                                                                                               push(this._soundManager);
                                                                                                               if(!_loc1_)
                                                                                                               {
                                                                                                                  continue;
                                                                                                               ...
                                                                                                               {
                                                                                                                  pop().(TrainArcher,"trainArcher");
                                                                                                                  while(true)
                                                                                                                  {
                                                                                                                     push(this._soundManager);
                                                                                                                     while(true)
                                                                                                                     {
                                                                                                                        pop().(TrainHorseman,"trainHorseman");
                                                                                                                        while(true)
                                                                                                                        {
                                                                                                                           if(!(_loc2_ && _loc2_))
                                                                                                                           {
                                                                                                                              ...
                                                                                                                              pop().(HorsemanDie,"horsemanDie");
                                                                                                                              if(!_loc2_)
                                                                                                                              {
                                                                                                                                 this._soundManager.(Scroll,"scroll");
                                                                                                                                 while(!(_loc2_ && _loc1_))
                                                                                                                                 {
                                                                                                                                    push(this._soundManager);
                                                                                                                                    while(true)
                                                                                                                                    {
                                                                                                                                       pop().(HitWall1,"hitWall1");
                                                                                                                                       if(!(_loc1_ || Boolean(this)))
                                                                                                                                       {
                                                                                                                                          break;
                                                                                                                                       }
                                                                                                                                       this._soundManager.(HitWall2,"hitWall2");
                                                                                                                                       while(true)
                                                                                                                                       {
                                                                                                                                          push(this._soundManager);
                                                                                                                                          if(_loc1_ || Boolean(this))
                                                                                                                                          {
                                                                                                                                             ...
                                                                                                                                             pop().(HitWall3,"hitWall3");
                                                                                                                                             while(true)
                                                                                                                                             {
                                                                                                                                                this._soundManager.(HitWall4,"hitWall4");
                                                                                                                                                push(this._soundManager);
                                                                                                                                                loop66:
                                                                                                                                                while(_loc1_)
                                                                                                                                                {
                                                                                                                                                   pop().(EventAlert,"eventAlert");
                                                                                                                                                   push(this._soundManager);
                                                                                                                                                   while(true)
                                                                                                                                                   {
                                                                                                                                                      if(_loc1_)
                                                                                                                                          ...
                                                                                                                                          while(!(_loc2_ && _loc1_))
                                                                                                                                          {
                                                                                                                                             ...
                                                                                                                                             else
                                                                                                                                             {
                                                                                                                                                ...
                                                                                                                                                while(true)
                                                                                                                                                {
                                                                                                                                                   pop().(MapUpgradeMusic,"mapAndUpgradeMusic");
                                                                                                                                                   if(!(_loc1_ || Boolean(this)))
                                                                                                                                                   {
                                                                                                                                                      break;
                                                                                                                                                   }
                                                                                                                        ...
                                                                                                                        continue loop49;
                                                                                                                        addr247:
                                                                                                                        pop().(DepletedTree,"depletedTree");
                                                                                                                        push(this._soundManager);
                                                                                                                        if(!_loc1_)
                                                                                                                        {
                                                                                                                           continue;
                                                                                                                        }
                                                                                                                        pop().(DepletedMine,"depletedMine");
                                                                                                                        push(this._frequencyLimiter);
                                                                                                                     }
                                                                                                                     pop().(NoResources,"noResources");
                                                                                                                     if(_loc2_ && _loc2_)
                                                                                                                     {
                                                                                                                        continue;
                                                                                                                     }
                                                                                                      ...
                                                                                                      while(true)
                                                                                                      {
                                                                                                         pop().(HumanDeath1,"humanDeath1");
                                                                                                         continue loop8;
                                                                                                      }
                                                                                                   }
                                                                                                }
                                                                                                pop().(BuildLoop,"buildLoop");
                                                                                                if(!(_loc1_ || _loc1_))
                                                                                                {
                                                                                                   continue;
                                                                                                }
                                          ...
                                          while(true)
                                          {
                                             this._soundManager.(HumanDeathChad3,"humanDeathChad3");
                                             if(_loc2_)
                                             {
                                                break;
                                             }
                                             ...
                                             this._soundManager.(HumanDeathChad4,"humanDeathChad4");
                                          }
                                       }
                                    }
                                 }
      ...
      private function updateFadeOutBuildSound() : void
      {
         ...
         if(this.buildSoundIsFading)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  pop().(pop(),1 - Number(this.buildFadeOutCounter) / 15);
               ...
               if(this.healSoundIsFading)
               {
                  ...
                  while(true)
                  {
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           pop().(pop(),1 - Number(this.healFadeOutCounter) / 15);
