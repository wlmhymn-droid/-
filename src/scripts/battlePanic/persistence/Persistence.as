package battlePanic.persistence
{
   ...
   public class Persistence
   {
      ...
      private static var _instance:battlePanic.persistence.Persistence;
      ...
      private var _crypt:battlePanic.persistence.LGCryptObject;
      ...
      public function Persistence(param1:SingletonBlocker)
      {
         ...
         if(_loc3_)
         {
            ...
            this._crypt = new battlePanic.persistence.LGCryptObject();
            do
            {
               super();
               do
      ...
      public static function getInstance() : battlePanic.persistence.Persistence
      {
         ...
         {
            push(_instance);
            if(!(_loc1_ && battlePanic.persistence.Persistence))
            {
               if(pop() == null)
               {
                  if(!_loc1_)
                  {
                     _instance = new battlePanic.persistence.Persistence(new SingletonBlocker());
                     addr53:
                     push(_instance);
                  }
               }
