package battlePanic.ui.techTree
{
   ...
   public class UpgradeManager
   {
      ...
      private static var _instance:battlePanic.ui.techTree.UpgradeManager;
      ...
      public static function getInstance() : battlePanic.ui.techTree.UpgradeManager
      {
         ...
         if(!(_loc1_ && _loc1_))
         {
            ...
            if(_loc2_ || _loc1_)
            {
               if(§§pop() == null)
               {
                  ...
                  {
                     addr52:
                     _instance = new battlePanic.ui.techTree.UpgradeManager(new SingletonBlocker());
                  }
               }
               return _instance;
            }
