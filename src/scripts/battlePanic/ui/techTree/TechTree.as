package battlePanic.ui.techTree
{
   ...
   public class TechTree extends RevealableView
   {
      ...
      private static var _instance:battlePanic.ui.techTree.TechTree;
       
      
      public const constants:battlePanic.ui.techTree.TechConstants;
      ...
      private var _tooltip:battlePanic.ui.techTree.TechTreeTooltip;
      ...
      private var _resetAreYouSure:battlePanic.ui.techTree.ResetAreYouSurePanel;
      ...
      public function TechTree(param1:SingletonBlocker)
      {
         ...
         {
            this.constants = battlePanic.ui.techTree.TechConstants.getInstance();
         ...
         while(true)
         {
            ...
            while(true)
            {
               this._tooltip = new battlePanic.ui.techTree.TechTreeTooltip();
      ...
      public static function getInstance() : battlePanic.ui.techTree.TechTree
      {
         var _loc1_:Boolean = true;
         var _loc2_:Boolean = false;
         if(_loc1_ || battlePanic.ui.techTree.TechTree)
         {
            push(_instance);
            if(!(_loc2_ && battlePanic.ui.techTree.TechTree))
            {
               if(pop() == null)
               {
                  if(!_loc2_)
                  {
                     addr46:
                     _instance = new battlePanic.ui.techTree.TechTree(new SingletonBlocker());
                  }
               }
               return _instance;
            }
      ...
      private function initUI() : void
      {
         ...
         if(_loc2_ || Boolean(this))
         {
            ...
            while(true)
            {
               this._resetAreYouSure = new battlePanic.ui.techTree.ResetAreYouSurePanel(this.clip.resetAreYouSure);
               loop1:
               while(true)
               {
                  push(this.clip);
      ...
      override public function arriveAfterTransition() : void
      {
         ...
         if(_loc1_)
         {
            LGDisplayListUtil.getInstance().(this,true,true,true);
         }
         loop0:
         while(true)
         {
