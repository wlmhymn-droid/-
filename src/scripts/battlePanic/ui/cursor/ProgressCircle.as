package battlePanic.ui.cursor
{
   ...
   public class ProgressCircle extends MovieClip
   {
      ...
      public function activate(param1:int, param2:int, param3:, param4:Number, param5:Number, param6:Number = 1, param7:* = 1) : void
      {
            ...
            if(!_loc10_)
            {
               if(pop() != pop())
               {
                  if(!(_loc10_ && Boolean(this)))
                  {
                     ...
                     if(_loc9_)
                     {
                        this.setCostFields(Math.ceil(_loc8_. * param6),Math.ceil(_loc8_. * param7));
                        addr81:
                        push(param2);
