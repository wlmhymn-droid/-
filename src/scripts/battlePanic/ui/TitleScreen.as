package battlePanic.ui
{
   ...
   public class TitleScreen extends RevealableView implements Transitionable
   {
      ...
      private static var _instance:battlePanic.ui.TitleScreen;
      ...
      private var _difficultySelect:battlePanic.ui.DifficultySelectScreen;
      ...
      public function TitleScreen(param1:SingletonBlocker)
      {
         ...
         while(true)
         {
            this._difficultySelect = new battlePanic.ui.DifficultySelectScreen();
            super();
            addChild(this._clip);
            loop1:
            while(true)
      ...
      public static function getInstance() : battlePanic.ui.TitleScreen
      {
         ...
         if(_loc1_)
         {
            ...
            if(!(_loc2_ && _loc1_))
            {
               if(pop() == null)
               {
                  ...
                  {
                     addr46:
                     _instance = new battlePanic.ui.TitleScreen(new SingletonBlocker());
                  }
               }
               return _instance;
            }
      ...
      public function setClick() : void
      {
         ...
         if(!_loc1_)
         {
            .setClick(this._playButton.target,this.playButtonClickedHandler);
         }
      }
      ...
      private function flattenBackground() : void
      {
         ...
         if(!_loc3_)
         {
            ...
            while(true)
            {
               ...
               {
                  LGDisplayListUtil.getInstance().(this._clip.background);
                  do
                  {
      ...
      public function stopAndResetAnimations() : void
      {
         ...
         if(_loc2_)
         {
            LGDisplayListUtil.getInstance().(this._clip,false,true,true);
         }
      }
      ...
      public function resetAndStartAnimations() : void
      {
         ...
         {
            LGDisplayListUtil.getInstance().(this._clip,true,true,true);
         }
      }
      ...
      override public function prepareToReveal() : void
      {
         ...
         while(true)
         {
            ...
            LGDisplayListUtil.getInstance().(this);
            loop1:
            while(true)
            {
      ...
      private function prepareToReturnToTitleFromDifficultySelectHandler(param1:Event) : void
      {
         ...
         if(!_loc2_)
         {
            LGDisplayListUtil.getInstance().(this._clip,true,false,true);
         }
      }
   }
}
