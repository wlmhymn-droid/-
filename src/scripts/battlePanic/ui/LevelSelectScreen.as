package battlePanic.ui
{
   ...
   public class LevelSelectScreen extends RevealableView implements Transitionable
   {
      ...
      private static var _instance:battlePanic.ui.LevelSelectScreen;
      ...
      public static function getInstance() : battlePanic.ui.LevelSelectScreen
      {
         ...
         if(_loc1_)
         {
            ...
            if(!(_loc2_ && _loc2_))
            {
               if(pop() == null)
               {
                  ...
                  {
                     addr41:
                     _instance = new battlePanic.ui.LevelSelectScreen(new SingletonBlocker());
                  }
               }
               return _instance;
            }
