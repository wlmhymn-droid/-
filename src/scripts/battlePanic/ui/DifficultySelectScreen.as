package battlePanic.ui
{
   ...
   public class DifficultySelectScreen extends RevealableView
   {
      ...
      private var _chooseDifficultyHomePosition:;
      
      private var _okButtonHomePosition:;
      ...
      public function DifficultySelectScreen()
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  this._chooseDifficultyHomePosition = new (this.clip.chooseDifficulty.x,this.clip.chooseDifficulty.y);
                  while(true)
                  {
                     this._okButtonHomePosition = new (this.clip.okButton.x,this.clip.okButton.y);
                     loop4:
                     while(_loc1_)
                     {
      ...
      private function flattenBackground() : void
      {
         ...
         if(_loc3_)
         {
            ...
            do
            {
               LGDisplayListUtil.getInstance().(this.clip.background);
               do
               {
      ...
      override public function prepareToReveal() : void
      {
         ...
         var _loc3_:Boolean = false;
         LGDisplayListUtil.getInstance().(this,false,true,true);
         loop0:
         while(true)
         {
            this.syncToPersistence();
