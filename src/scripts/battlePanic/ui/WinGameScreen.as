package battlePanic.ui
{
   ...
   public class WinGameScreen extends RevealableView
   {
      ...
      private static var _instance:battlePanic.ui.WinGameScreen;
      ...
      public static function getInstance() : battlePanic.ui.WinGameScreen
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc2_)
            {
               if(§§pop() == null)
               {
                  if(!_loc1_)
                  {
                     _instance = new battlePanic.ui.WinGameScreen(new SingletonBlocker());
                     addr43:
                     §§push(_instance);
                  }
               }
