package battlePanic.ui
{
   ...
   public class InGameUI extends MovieClip
   {
      ...
      private static var _instance:battlePanic.ui.InGameUI;
      ...
      public var unitsBar:battlePanic.ui.UnitsBar;
      ...
      private var areYouSurePanel:battlePanic.ui.AreYouSurePanel;
      
      private var _premiumButtonsContainer:MovieClip;
      
      private var _premiumButtonsHomeY:int;
      
      private var _moreGoldDropdownSideController:battlePanic.ui.DropdownController;
      
      private var _moreWoodDropdownSideController:battlePanic.ui.DropdownController;
      
      private var _eliteReinforcementsDropdownSideController:battlePanic.ui.DropdownController;
      
      private var _eliteReinforcementsDropdownTopController:battlePanic.ui.DropdownController;
      ...
      public function InGameUI()
      {
         ...
         if(!(_loc2_ && _loc1_))
         {
            ...
            this.areYouSurePanel = new battlePanic.ui.AreYouSurePanel();
            loop0:
            while(true)
            {
               super();
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              ...
                              while(true)
                              {
                                             ...
                                             if(_loc3_ || Boolean(this))
                                             {
                                                ...
                                                while(true)
                                                {
                                                            ...
                                                            if(!_loc2_)
                                                            {
                                                               ...
                                                               while(true)
                                                               {
                                                                  ...
                                                                  while(true)
                                                                  {
                                                                     ...
                                                                     while(true)
                                                                     {
                                                                        this._moreGoldDropdownSideController = new battlePanic.ui.DropdownController(this._moreGoldButtonSide.target,this._moreGoldDropdownSide);
                                                                        addr507:
                                                                        addr461:
                                                                        while(true)
                                                                        {
                                                                        ...
                                                                        while(true)
                                                                        {
                                                                           ...
                                                                           this._eliteReinforcementsDropdownSideController = new battlePanic.ui.DropdownController(this._eliteReinforcementsButtonSide.target,this._eliteReinforcementsDropdownSide);
                                                                           while(!_loc2_)
                                                                           {
                                                                              if(_loc2_)
                                                                              {
                                                   ...
                                                   while(true)
                                                   {
                                                      ...
                                                      while(true)
                                                      {
                                                         this._moreWoodDropdownSideController = new battlePanic.ui.DropdownController(this._moreWoodButtonSide.target,this._moreWoodDropdownSide);
                                                      }
                                                   }
                                                   addr251:
                                                }
                                 ...
                                 while(true)
                                 {
                                    this._eliteReinforcementsDropdownTopController = new battlePanic.ui.DropdownController(this._eliteReinforcementsButtonTop.target,this.eliteReinforcementsDropdown);
                                 }
                              }
                           }
                        }
