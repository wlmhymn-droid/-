                        ...
                        while(!_loc6_)
                        {
                           ...
                           while(true)
                           {
                              if(pop())
                              {
                                 while(true)
                                 {
                                    LGDisplayListUtil.getInstance().(DisplayObjectContainer(this._target),false,false,true);
                                    addr120:
                                    while(true)
                                    {
                                    }
               ...
               while(true)
               {
                  if(pop())
                  {
                     if(!(_loc5_ && Boolean(param1)))
                     {
                        ...
                        LGDisplayListUtil.getInstance().(DisplayObjectContainer(this._target),true,true,true);
                     }
                     loop2:
                     while(true)
                     {
