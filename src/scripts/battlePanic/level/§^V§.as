   ...
   public class  extends Level
   {
      ...
      override protected function init() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               .spawnTimeStretch = 0.8;
               loop2:
               while(true)
               {
                  .spreadTimeStretch = 0.8;
                  if(!(_loc1_ || _loc1_))
                  {
                     break;
                  }
                  .spawnTimeOffset = 30;
                   ...
                   = 250;
                   = Level4Layout;
                  .addUnitGroup(ORC1,5,60,5,false);
                  .addUnitGroup(ORC1,25,60,15,true);
                  .addUnitGroup(ORC3,10,100,15,true);
                  .addUnitGroup(ORC1,30,100,8,false);
                  loop3:
                  while(true)
                  {
                     .addUnitGroup(ORC2,5,100,10,false);
                     while(true)
                     {
                        .addUnitGroup(ORC1,10,130,20,true);
                        while(true)
                        {
                           .addUnitGroup(ORC1,35,150,20,true);
                           .addUnitGroup(ORC2,5,160,10,true);
                           addr178:
                           while(true)
                           {
                              .addUnitGroup(ORC3,5,160,10,false);
                              continue loop0;
                           }
                           addr39:
                           super.init();
                        ...
                        continue loop2;
                        addr124:
                        .addUnitGroup(ORC3,20,250,20,true);
                        do
                        {
                           .addUnitGroup(ORC2,4,250,5,false);
                        }
                        while(_loc2_ && _loc2_);
