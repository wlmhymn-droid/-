package battlePanic.level
{
   ...
   public class  extends Level
   {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  ...
                  {
                     .insertPause(40);
                     .addUnitGroup(RED_ORC1,20,40,10,true);
                     .addUnitGroup(RED_ORC1,20,60,10,true);
                     while(true)
                     {
                        .insertPause(10);
                        continue loop1;
                        ...
                        while(!(_loc1_ && _loc1_))
                        {
                           .addUnitGroup(RED_ORC1,10,280,10,true);
                           .insertPause(10);
                           .addUnitGroup(RED_ORC3,20,300,10,true);
                           addr168:
                           if(!(_loc2_ || Boolean(this)))
                           {
                              while(_loc2_)
                              {
                                 .addUnitGroup(RED_ORC3,15,230,10,false);
                                 .addUnitGroup(RED_ORC1,20,230,10,false);
                                 .addUnitGroup(RED_ORC4,10,240,20,true);
                                 .addUnitGroup(RED_ORC1,10,240,10,false);
                                 .insertPause(5);
                              }
                              while(true)
                              {
                                 ...
                                 .addUnitGroup(RED_ORC3,10,100,20,true);
                                 loop7:
                                 while(true)
                                 {
                                    .addUnitGroup(RED_ORC1,20,100,30,false);
                                    .addUnitGroup(RED_ORC1,30,140,10,true);
                                    while(true)
                                    {
                                       if(_loc2_)
                                       {
                                       ...
                                       continue loop7;
                                       addr353:
                                       .addUnitGroup(RED_ORC2,5,140,5,false);
                                       .addUnitGroup(RED_ORC3,10,140,10,false);
                                       if(_loc2_)
                                       {
                                          continue loop2;
                                       }
                           ...
                           .addUnitGroup(RED_ORC2,10,330,10,true);
                           while(true)
                           {
                              .addUnitGroup(RED_ORC1,20,330,10,false);
                              continue loop13;
                              addr113:
                              .addUnitGroup(RED_ORC3,20,330,20,false);
                              if(_loc1_ && _loc1_)
                              {
                                 continue;
                              }
                              ...
                              if(!(_loc1_ && _loc1_))
                              {
                                 .addUnitGroup(RED_ORC2,10,370,10,true);
                                 .addUnitGroup(RED_ORC3,10,370,10,false);
                                 .addUnitGroup(RED_ORC4,12,370,10,false);
                                 while(_loc2_ || _loc1_)
                                 {
                                    super.init();
                                    if(!_loc2_)
                                    ...
                                    if(_loc2_ || Boolean(this))
                                    {
                                       ...
                                       while(true)
                                       {
                                          .addUnitGroup(RED_ORC1,10,250,10,true);
                                          addr186:
                                          while(true)
                                          {
                                             .addUnitGroup(RED_ORC3,10,250,20,false);
                                          }
                                       }
                                       addr191:
                                    }
                                    while(true)
                                    {
                                       .addUnitGroup(RED_ORC2,15,280,10,true);
                                       continue loop13;
                                    }
                                 }
                                 continue loop13;
      ...
      override public function update() : void
      {
         ...
         {
            super.update();
            if(.isCurrentStretchedTime(200))
            {
               this.();
               shared.sound.playSound("reinforcements");
               addr79:
            }
            if(.isCurrentStretchedTime(230))
            {
               do
               {
                  this.();
      ...
      private function () : void
      {
         ...
         while(_loc3_ < 5)
         {
            _loc2_ = _loc1_.getCombatant(_loc1_.);
            if(!(_loc4_ && Boolean(_loc3_)))
            {
               _loc2_.x = this..x + Math.random() * this..width;
            }
            _loc2_.y = this..y + Math.random() * this..height;
      ...
      private function () : void
      {
         ...
         while(_loc2_ < 50)
         {
            _loc1_ = _loc3_.getCombatant(_loc3_.);
            if(_loc5_)
            {
               _loc1_.x = this..x + Math.random() * this..width;
               while(true)
               {
                  _loc1_.y = this..y + Math.random() * this..height;
