            ...
            while(true)
            {
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     ...
                     while(!_loc1_)
                     {
                        .addUnitGroup(ORC1,20,30,20,true);
                        .addUnitGroup(ORC3,10,50,20,true);
                        while(!_loc1_)
                        {
                           .addUnitGroup(ORC2,8,50,6,false);
                           loop6:
                           while(!(_loc1_ && _loc2_))
                           {
                              .addUnitGroup(ORC1,30,90,15,true);
                              while(true)
                              {
                                 .addUnitGroup(ORC3,10,100,15,false);
                                 continue loop6;
                                 addr159:
                                 .insertPause(15);
                                 .addUnitGroup(ORC1,40,150,10,true);
                                 if(_loc2_ || _loc2_)
                                 {
                                    .addUnitGroup(RED_ORC1,15,150,10,true);
                                    do
                                    {
                                       .addUnitGroup(ORC1,45,200,5,true);
                                       .addUnitGroup(RED_ORC1,15,200,5,false);
                                       do
                                       {
                                          .addUnitGroup(RED_ORC2,10,200,15,false);
                                          addr81:
                                          loop12:
                                          while(_loc2_ || _loc1_)
                                          {
                                             .addUnitGroup(RED_ORC3,25,210,5,true);
                                             while(true)
                                             {
                                                if(!_loc1_)
                                                {
                                          ...
                                          while(true)
                                          {
                                             .addUnitGroup(ORC1,40,130,10,true);
                                             .addUnitGroup(RED_ORC2,10,130,10,false);
                                             if(_loc1_ && _loc1_)
                                             {
                                                break;
                                             }
         ...
         while(true)
         {
            ...
            while(pop())
            {
               while(true)
               {
                  ...
                  push(.isCurrentStretchedTime(130));
                  if(_loc2_)
                  {
                     if(_loc2_)
                     {
