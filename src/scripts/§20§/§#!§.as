package 
{
   public class 
   {
      ...
      
      {
         ...
         if(!_loc2_)
         {
             = new Array([1331049639,-1207471120,-2100379815,561778359],[340133707,2007216329,406818857,310181280],[-623296111,-310886824,1805578827,-1039631421]);
            if(!_loc2_)
            {
                                                   ...
                                                   if(_loc10_)
                                                   {
                                                      ...
                                                      if(_loc10_)
                                                      {
                                                         ...
                                                         if(!(_loc11_ && Boolean(param1)))
                                                         {
                                                            ...
                                                            {
                                                               addr176:
                                                               push(pop() + _loc6_ ^ _loc9_ + int([param2 + 3 ^ 192][_loc9_ >>> 11 & 3]));
                                                            }
                                                         }
                                                      }
                                                      push(pop() - pop());
                                                         ...
                                                         if(_loc10_)
                                                         {
                                                            ...
                                                            if(!_loc11_)
                                                            {
                                                               ...
                                                               if(!(_loc11_ && ))
                                                               {
                                                                  ...
                                                                  addr267:
                                                                  push(pop() + pop() ^ _loc9_ + int([param2 + 3 ^ 192][_loc9_ & 3]));
                                                               }
                                                               push(_loc7_);
                                                            }
                                                         }
