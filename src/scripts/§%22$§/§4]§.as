package 
{
   ...
   public class 
   {
      ...
      public function (param1:*, param2:String) : Boolean
      {
      ...
      public function (param1:String, param2:String, param3:Number = 1000, param4:Boolean = false) : Boolean
      {
      ...
      public function (param1:Boolean = false) : void
      {
         ...
         while(_loc2_ < this._sounds.length)
         {
            ...
            while(true)
            {
               ...
               if(_loc4_)
               {
                  if(this.[_loc3_].pausedByAll)
                  {
                     if(!_loc4_)
                     {
                        continue;
                     }
                     this.[_loc3_].pausedByAll = false;
                     while(true)
                     {
                        this.playSound(_loc3_);
                        break loop1;
      ...
      public function (param1:Boolean = true) : void
      {
         ...
         while(_loc2_ < this._sounds.length)
         {
            ...
            if(param1)
            {
               ...
               {
                  if(!this.[_loc3_].paused)
                  {
                     this.[_loc3_].pausedByAll = true;
      ...
      public function (param1:String, param2:Number = 0, param3:Number = 1) : void
      {
         var _loc5_:Boolean = false;
         var _loc6_:Boolean = true;
         var _loc4_:SoundChannel = this.[param1].channel;
      ...
      {
         return this.[param1].channel.soundTransform.volume;
      }
      
      public function (param1:String) : Number
      {
         return this.[param1].channel.position;
      }
      
      public function (param1:String) : Number
      {
         return this.[param1].sound.length;
      }
      
      public function (param1:String) : Sound
      {
         return this.[param1].sound;
      }
      
      public function (param1:String) : Boolean
      {
         return this.[param1].paused;
      }
      
      public function (param1:String) : Boolean
      {
         return this.[param1].pausedByAll;
      }
