package 
{
   ...
   public class LGDisplayListUtil
   {
      ...
      public function (param1:DisplayObjectContainer, param2:Boolean, param3:Boolean = false, param4:Boolean = true) : void
      {
                                    ...
                                    if(pop())
                                    {
                                       ...
                                       while(true)
                                       {
                                          ...
                                          while(true)
                                          {
                                             ...
                                             while(true)
                                             {
                                                this.(DisplayObjectContainer(_loc7_),param2,param3);
                                                loop2:
                                                while(true)
                                                {
                                                   if(!(_loc9_ && param3))
      ...
      public function (param1:*, param2:*, param3:Number = 0, param4:Number = 0) : void
      {
      ...
      public function (param1:*, param2:Number) : void
      {
         var _loc5_:Boolean = false;
         var _loc6_:Boolean = true;
         var _loc3_:int = 0;
      ...
      public function (param1:DisplayObjectContainer, param2:Class) : Array
      {
         var _loc5_:Boolean = false;
         var _loc6_:Boolean = true;
         var _loc4_:int = 0;
      ...
      public function (param1:DisplayObject, param2:DisplayObjectContainer) : void
      {
         var _loc4_:Boolean = true;
         var _loc5_:Boolean = false;
         var _loc3_:Point = this.(new Point(param1.x,param1.y),param1.parent,param2);
         if(!_loc5_)
         {
      ...
      public function (param1:Point, param2:DisplayObject, param3:DisplayObject) : Point
      {
