package §32§
{
   ...
   public class LGDisplayListUtil
   {
      ...
      private static var _instance:§32§.LGDisplayListUtil;
      ...
      public static function getInstance() : §32§.LGDisplayListUtil
      {
         ...
         if(!_loc2_)
         {
            ...
            if(_loc1_)
            {
               if(§§pop() == null)
               {
                  ...
                  {
                     addr41:
                     _instance = new §32§.LGDisplayListUtil(new SingletonEnforcer());
                  }
               }
               return _instance;
            }
