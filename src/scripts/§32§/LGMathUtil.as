package §32§
{
   ...
   public class LGMathUtil
   {
      ...
      private static var _instance:§32§.LGMathUtil;
      ...
      public static function getInstance() : §32§.LGMathUtil
      {
         ...
         {
            §§push(_instance);
            if(_loc2_ || §32§.LGMathUtil)
            {
               if(§§pop() == null)
               {
                  if(!_loc1_)
                  {
                     _instance = new §32§.LGMathUtil(new SingletonEnforcer());
                     addr48:
                     §§push(_instance);
                  }
               }
