package §+5§
{
   ...
   public class PremiumItems
   {
      ...
      private static var _instance:§+5§.PremiumItems;
      ...
      public static function getInstance() : §+5§.PremiumItems
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc1_)
            {
               if(§§pop() == null)
               {
                  if(!(_loc2_ && §+5§.PremiumItems))
                  {
                     _instance = new §+5§.PremiumItems(new SingletonBlocker());
                     addr47:
                     §§push(_instance);
                  }
               }
