package 
{
   ...
   public class 
   {
      ...
      public function (param1:Point) : Point
      {
      ...
      public function angleTo(param1:) : Number
      {
                                                         ...
                                                         if(!_loc8_)
                                                         {
                                                            ...
                                                            if(!(_loc8_ && Boolean(param1)))
                                                            {
                                                               ...
                                                               if(pop() < -1)
                                                               {
                                                                  ...
                                                                  var _loc6_:;
                                                                  push((_loc6_ = new pop().(pop(),this.x)).x);
                                                                  if(_loc9_)
                                                                  {
                                                                     push(param1.x);
                                                                     if(_loc9_)
      ...
      public function rotateTowardVector(param1:, param2:Number) : void
      {
         var _loc4_:Boolean = false;
      ...
      public function () : 
      {
         ...
         return new pop().(pop(),this.x);
      }
      
      public function rotateBy(param1:Number) : 
      {
         var _loc4_:Boolean = false;
         var _loc5_:Boolean = true;
         push(this.getAngle());
      ...
      public function (param1:Number = 1) : 
      {
         var _loc2_:Boolean = true;
         var _loc3_:Boolean = false;
         if(_loc2_ || Boolean(this))
      ...
      public function setLength(param1:Number) : 
      {
         var _loc2_:Boolean = true;
         var _loc3_:Boolean = false;
         if(_loc2_)
      ...
      public function (param1:*) : 
      {
         var _loc3_:Boolean = true;
         var _loc4_:Boolean = false;
         var _loc2_: = new (param1.x - this.x,param1.y - this.y);
         if(_loc3_ || Boolean(_loc2_))
         {
      ...
      public function (param1:*) : 
      {
         return new (this.x + param1.x,this.y + param1.y);
      }
