package §0?§
{
   ...
   public class §,[§ extends EventDispatcher
   {
      ...
      final public function §^@§(param1:§0?§.§,[§ = null, param2:Array = null) : *
      {
      ...
      final public function § 2§(param1:String, param2:§0?§.§,[§) : void
      {
         var _loc3_:Boolean = false;
      ...
      final public function isCurrently(param1:§0?§.§,[§) : Boolean
      {
         return param1.contains(this.§7T§());
      }
      
      final public function contains(param1:§0?§.§,[§) : Boolean
      {
      ...
      final public function §!8§(param1:§0?§.§,[§ = null) : void
      {
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = true;
         this.enterActions();
      ...
      private function §68§(param1:String) : §0?§.§,[§
      {
         var _loc4_:Boolean = false;
