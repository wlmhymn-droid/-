   ...
   public class 
   {
      ...
      public function writeObject() : Object
      {
         ...
         if(!_loc6_)
         {
            ...
            {
               addr26:
               this._stuffEncoded = this.(this.stuff);
            }
            var _loc1_:Object = {};
            var _loc4_:* = 0;
            var _loc5_:* = ;
                                 ...
                                 while(true)
                                 {
                                    ...
                                    while(_loc5_)
                                    {
                                       ...
                                       if(_loc5_)
                                       {
                                          try
                                          {
                                             this.stuff = this.(this._stuffEncoded);
                                             if(_loc5_)
                                             {
                                                push(-1);
                                                if(_loc5_ || _loc2_)
      ...
      private function (param1:String) : Object
      {
                                 ...
                                 if(_loc3_ || _loc2_)
                                 {
                                    ...
                                    while(true)
                                    {
                                       while(true)
                                       {
                                          ...
                                          push(this.(this.stuff,param1.stuff));
                                          addr92:
                                          continue loop2;
                                          if(!(_loc3_ || _loc2_))
                                          {
      ...
      private function (param1:Object, param2:Object) : Boolean
      {
         var _loc3_:Boolean = true;
         var _loc4_:Boolean = false;
         if(param1 == null)
                        ...
                        while(true)
                        {
                           ...
                           while(!pop())
                           {
                              ...
                              while(true)
                              {
                                 ...
                                 {
                                    addr426:
                                    push(param2 is Array && this.(param1,param2));
                                 }
                                 else
                                 {
