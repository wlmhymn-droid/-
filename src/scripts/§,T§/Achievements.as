package §,T§
{
   ...
   public class Achievements
   {
      ...
      private static var _instance:§,T§.Achievements;
      ...
      public static function getInstance() : §,T§.Achievements
      {
         ...
         if(_loc2_)
         {
            ...
            if(!(_loc1_ && _loc2_))
            {
               if(§§pop() == null)
               {
                  if(!(_loc1_ && §,T§.Achievements))
                  {
                     _instance = new §,T§.Achievements(new SingletonBlocker());
                     addr53:
                     §§push(_instance);
                  }
               }
