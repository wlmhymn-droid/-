                        ...
                        else
                        {
                           ...
                           while(true)
                           {
                              ...
                              if(_loc6_)
                              {
                                 ...
                                 addr203:
                                 §§push(this.vars.timeline is com.greensock.core.SimpleTimeline);
                              }
                              addr208:
                              if(§§pop())
                              {
                                 addr227:
                                 var _loc3_:com.greensock.core.SimpleTimeline = !_loc5_ ? this.vars.timeline : TweenLite.rootFramesTimeline;
