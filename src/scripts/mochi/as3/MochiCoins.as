package mochi.as3
{
   public class MochiCoins
   {
      ...
      public static var _inventory:mochi.as3.MochiInventory;
      
      private static var _dispatcher:mochi.as3.MochiEventDispatcher;
      
      {
         ...
         {
            NO_USER = "NoUser";
            _dispatcher = new mochi.as3.MochiEventDispatcher();
            addEventListener(MochiSocial.LOGGED_IN,function(param1:Object):void
            {
               _inventory = new mochi.as3.MochiInventory();
            });
      ...
      public static function get inventory() : mochi.as3.MochiInventory
      {
         return _inventory;
      }
