package battlePanic.ui
{
   ...
   public class Hourglass extends MovieClip
   {
      ...
      private static var _instance:battlePanic.ui.Hourglass;
      ...
      public static function getInstance() : battlePanic.ui.Hourglass
      {
         ...
         {
            push(_instance);
            if(_loc1_ || battlePanic.ui.Hourglass)
            {
               if(pop() == null)
               {
                  if(!(_loc2_ && battlePanic.ui.Hourglass))
                  {
                     addr51:
                     _instance = new battlePanic.ui.Hourglass(new SingletonBlocker());
                  }
               }
               return _instance;
            }
