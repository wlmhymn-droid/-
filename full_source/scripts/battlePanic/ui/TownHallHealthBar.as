package battlePanic.ui
{
   ...
   public class TownHallHealthBar extends MovieClip
   {
      ...
      private static var _instance:battlePanic.ui.TownHallHealthBar;
      ...
      public static function getInstance() : battlePanic.ui.TownHallHealthBar
      {
         ...
         if(!(_loc2_ && _loc1_))
         {
            ...
            if(_loc1_)
            {
               if(pop() == null)
               {
                  ...
                  {
                     addr41:
                     _instance = new battlePanic.ui.TownHallHealthBar(new SingletonBlocker());
                  }
               }
               return _instance;
            }
