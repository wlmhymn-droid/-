package battlePanic.ui.spamAlertCache
{
   ...
   public class SpamAlertCache
   {
      ...
      private static var _instance:battlePanic.ui.spamAlertCache.SpamAlertCache;
      ...
      public static function getInstance() : battlePanic.ui.spamAlertCache.SpamAlertCache
      {
         var _loc1_:Boolean = true;
         var _loc2_:Boolean = false;
         if(!(_loc2_ && battlePanic.ui.spamAlertCache.SpamAlertCache))
         {
            push(_instance);
            if(_loc1_ || _loc1_)
            {
               if(pop() == null)
               {
                  ...
                  {
                     addr46:
                     _instance = new battlePanic.ui.spamAlertCache.SpamAlertCache(new SingletonBlocker());
                  }
               }
               return _instance;
            }
      ...
      public function getWoodSpam(param1:int) : 
      {
      ...
      public function getGoldSpam(param1:int) : 
      {
