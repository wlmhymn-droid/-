package battlePanic.ui.techTree
{
   ...
   public class TechIconController extends ExpandRolloverButton
   {
      ...
      private var _starsUnlocked:;
      
      private var _starsIncludingInvested:;
      
      private var stars:battlePanic.ui.techTree.StarsSelector;
      ...
      public function TechIconController(param1:MovieClip, param2:String)
      {
         ...
         this.upgradeLevel = new ();
         this._starsUnlocked = new ();
         while(true)
         {
            this._starsIncludingInvested = new ();
            this.stars = new battlePanic.ui.techTree.StarsSelector();
