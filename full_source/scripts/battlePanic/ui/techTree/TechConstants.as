package battlePanic.ui.techTree
{
   public class TechConstants
   {
      ...
      private static var _instance:battlePanic.ui.techTree.TechConstants = null;
      ...
      public static function getInstance() : battlePanic.ui.techTree.TechConstants
      {
         ...
         if(!(_loc1_ && _loc1_))
         {
            ...
            if(!(_loc1_ && _loc1_))
            {
               if(pop() == null)
               {
                  if(!_loc1_)
                  {
                     _instance = new battlePanic.ui.techTree.TechConstants(new SingletonBlocker());
                     addr53:
                     push(_instance);
                  }
               }
