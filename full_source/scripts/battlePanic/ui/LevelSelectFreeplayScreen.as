package battlePanic.ui
{
   ...
   public class LevelSelectFreeplayScreen extends RevealableView implements Transitionable
   {
      ...
      private static var _instance:battlePanic.ui.LevelSelectFreeplayScreen;
      ...
      private var _highScoreSelectPane:;
      ...
      public static function getInstance() : battlePanic.ui.LevelSelectFreeplayScreen
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc2_ || _loc1_)
            {
               if(pop() == null)
               {
                  ...
                  {
                     addr42:
                     _instance = new battlePanic.ui.LevelSelectFreeplayScreen(new SingletonBlocker());
                  }
               }
               return _instance;
            }
